...
Donc $\tilde{\theta}_n$ suit une loi normale $\mathcal{N}(\theta, 4(\theta^2 - 1)/12n)$.

Alors on a une confiance $1 - \alpha$ en l'inégalité suivante :

$$
(E) \bar{X}_n - \frac{2 \sqrt{\theta^2 - 1}}{\sqrt{12n^2}} u_{\alpha} \leq \theta \leq \bar{X}_n + \frac{2 \sqrt{\theta^2 - 1}}{\sqrt{12n^2}} u_{\alpha}
$$
...
$$
\begin{aligned}
  (E) \ &\Leftrightarrow  - \frac{2 \sqrt{\theta^2 - 1}}{\sqrt{12n^2}} u_{\alpha} \leq \theta - \bar{X}_n \leq \frac{2 \sqrt{\theta^2 - 1}}{\sqrt{12n^2}} u_{\alpha} \\
      &\Leftrightarrow  (\theta - \bar{X}_n)^2 \leq \frac{4 \theta^2 - 4}{12n^2} u_{\alpha} \\
\end{aligned}
$$
